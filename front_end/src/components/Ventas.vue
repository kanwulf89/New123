                      ...
                      <b-col md="6">
                        <b-card-text>
                          <form>
                            ...
                            <b-card-text>Fecha Venta:{{i.facturax.created_at}}</b-card-text>
                            <b-card-text>Cliente:{{i.pedido1.cliente.nombre}}</b-card-text>
  ...
  export default {
    ...
    methods:{
      cargaProductosComprados(){
        ...
        this.$store.dispatch('BuscaProductosVendidos',this.valida)
        .then(res=>{
